...
I think today's most xUnit libraries are too much complex, so and there are
some good reasons to "reinvent the wheel". `should` simply and justly supports 
the key concepts of [Kent Beck's original testing framework](http://www.xprogramming.com/testfram.htm).
