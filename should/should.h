...
void should_be_not_equal_strings_(
		const char *val1,
		const char *val2, 
		const char *expr_str,
		const char *file,
...
/*!
 * \brief Destroys the test suite and its all children recursively
 */
void
